...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/ClwyJY4xY/model.json',modelLoaded);
...
classifier.classify(image,recive);
  }
  function recive(error,result){
if(error){
    console.log(error);
}
console.log(result);
